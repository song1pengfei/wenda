            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">{{session("adminuser")->admin_name}}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="{{asset('myadmin/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image" />
                    <p>
                     {{session("adminuser")->admin_name}}-网站开发
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            ...
            <div class="pull-left info">
              <p>{{session("adminuser")->admin_name}}</p>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="/admin/logins"><i class="fa fa-youtube-play"></i> 用户管理</a></li>
                <li class="active"><a href="/admin/user"><i class="fa fa-youtube-play"></i> 个人信息管理</a></li>
                <li class="active"><a href="/admin/admin"><i class="fa fa-youtube-play"></i> 后台用户管理</a></li>
                <li class="active"><a href="/admin/log"><i class="fa fa-youtube-play"></i> 用户日志管理</a></li>
                </ul>
            </li>
            
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 问题管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">

                <li class="active"><a href="{{url('admin/question')}}"><i class="fa fa-circle-o"></i> 提问信息</a></li>
                <li><a href="{{url('admin/answer')}}"><i class="fa fa-circle-o"></i> 答案信息</a></li>
                 <li><a href="{{url('admin/comment')}}"><i class="fa fa-circle-o"></i> 评论信息</a></li>
              </ul>
            </li>
            
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 积分管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 分类管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{url('admin/lanmu')}}"><i class="fa fa-circle-o"></i> 栏目分类</a></li>
                <li class="active"><a href="{{url('admin/lanmu/create')}}"><i class="fa fa-circle-o"></i> 添加栏目</a></li>
              </ul>
            </li>
			
			<li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 友情链接</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
			...
			<li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 公告管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{url('admin/notice')}}"><i class="fa fa-circle-o"></i> 公告信息</a></li>
                <li class="active"><a href="{{url('admin/AddNotice')}}"><i class="fa fa-circle-o"></i> 添加公告</a></li>
             </ul>
            </li>
			
			<li class="active treeview">
              <a href="#">
                <i class="fa fa-bomb"></i> <span> 广告管理</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{url('admin/adu')}}"><i class="fa fa-circle-o"></i> 广告浏览</a></li>
                <li class="active"><a href="{{url('admin/AduInsert')}}"><i class="fa fa-circle-o"></i> 添加广告</a></li>
              </ul>
            </li>
