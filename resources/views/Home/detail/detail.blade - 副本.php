                ...
                <div class="wgt-answers" id="wgt-answers">
					...
					<div class="bd-wrap">
                        ...
                        <div class="bd answer answer-first answer-fold" id="answer-2781724496">
                                ...
                                <div class="line content">
                                    ...
                                    <div class="line info f-light-gray mt-10 mb-5 f-12">
													            ...
													            $.ajax({
																 ...
																 success:function(data){
																	 ...
																	 for(var i in data){
																		 ...
																		 for(var j in data[i]){
																			 //alert(data[i][j]);
																			 $("<h4><b>"+"我："+data[i][j]+"</b></h4>").css({left:10+"px"}).insertBefore("#fid");
																		 }
																	 }
																	//$("#addid").hide();
                                        ...
                                        <div class="grid-r f-aid pos-relative" >
                                            <div id="pinglun" style="float:left;>
                                            ...
                                            <div id="ckpl" style="float:left;">
                                            <!--<a href="javascript:void(0)" onclick="opendiv({{$AnswerList[$i]['answer_id']}})" id="aaa">查看已有评论</a>-->
                                            <a href="javascript:void(0)" onclick="opendiv()" id="aaa">查看已有评论</a>
                                            <!--<a href="{{URL('/comment/show')}}/{{$AnswerList[$i]['answer_id']}}">查看已有评论</a>-->
                                            </div>
                                            <div class="qb-zan-eva" style="float:left;">
                                                <span alog-action="qb-zan-btn" class="iknow-qb_home_icons evaluate evaluate-32" id="evaluate-2781724496" data-evaluate="0"><i class="iknow-qb_home_icons i-evaluate"></i><b class="evaluate-tip" style="display:none" id="75-tip">赞</b><b class="evaluate-num evaluate-num-fixed" id="75-num">0</b></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div id="commentdiv" style="display:none;border:1px solid silver;height:250px;width:690px;"></div>

                            <script>
                                function opendiv(){
								  $("this").off("click");
                                  $("#commentdiv").off("click");
								  $.ajax({
											...
											for(var i in data){
                                                for(var j in data[i]){
                                                   for(var k in data[i][j]){
														    $("#commentdiv").append(data[i][j][k]+"<br/>");
													}
                                                }
                                            }
                            ...
                            <div id="addid" style="display:none;width:600px;">
