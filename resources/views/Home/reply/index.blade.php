            ...
            <div class="q-operation mt-10 mb-5 f-pening" id="q-operation">
                <div id="ope-action" class="asker-op-btn">
                    <a href="#" class="mr-5 asker-op-buttons" alog-alias="qb-ask-addit">
                        修改答案<i class="ml-5 i-incline-down"></i>
                    </a>
               ...
               <div class="ask-main-box">
                    <div class="question-description f-pening" id="question-description">
                        <form action="{{url('home/AgainAnswer/update')}}/{{$Answer[$i]['id']}}" method="post" enctype="multipart/form-data">
                           <input type="hidden" name="_token" value=" {{csrf_token()}}">
                           <input type="hidden" name="id" value="{{$Answer[$i]['id']}}"/>
                           <input type="hidden" name="ques_id" value="{{$Answer[$i]['ques_id']}}"/>
                            <div class="qd-layout">
                                ...
                                <div class="qd-content qd-content-desc">
                                    <div class="qd-ct qd-desc">
                                       ...
                                       <textarea id="content-area" class="editor" tools="mini" name="answer_content">{{$Answer[$i]['answer_content']}}
                                        </textarea>
                                    </div>
