         ...
         <div class="con">
         	<div class="item-phone-wrap">
							<div class="form-item form-item-phone">
								...
								<input type="text" id="form-phone" onblur="checkPhone()" name="phone" class="field" placeholder="建议使用常用手机" autocomplete="off" maxlength="11" default="&lt;i class=&quot;i-def&quot;&gt;&lt;/i&gt;完成验证后，可以使用该手机登录和找回密码">
								<i class="i-status">
								</i>
								<div id="scrollbar1">
									<div class="scrollbar">
          ...
          <div class="am-tab-panel">
                <form method="post">
                    ...
                    <button id="getPhoneCode" class="btn-phonecode" type="button">
                        获取验证码
                    </button>
                    <i class="i-status">
                    </i>
