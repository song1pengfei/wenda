...
<div id="userbar" class="userbar userbar-renew" data="">
    <ul class="aside-list">
        ...
        <li>
            <a href="/ihome?tab=1" class="user-name" target="_blank" id="user-name">{{ $sessioninfo[0]->login_name}}<i class="i-arrow-down"></i></a>
        </li>
        </li>
    ...
    <div class="layout-wrap">
        ...
        <div class="wgt-ask accuse-response line mod-shadow " id="wgt-ask">
            <h1 accuse="qTitle">
                ...
                <span class="ask-title ">{{ $vdata->ques_title }}</span>
            </h1>

            <div class="line mt-5 q-content" accuse="qContent" style="display:{{isset($data->ques_details)?'block':'none'}}">
				<span class="con" id="deta">{{$vdata->ques_details}}<br /><br /></span>
			</div>
			

            <div class="line f-aid ask-info ff-arial" id="ask-info">
                <span>{{ $vdata->updated_at }}</span>
 ...
 <!--               <div class="ope-action-show show-added" style="display: none;">
               ...
               <div class="ask-main-box">
                    <div class="question-description f-pening" id="question-description">
                        <form action="{{url('home/question')}}/{{ $vdata->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="qd-layout">
                                ...
                                <div class="qd-content qd-content-desc">
                                    <div class="qd-ct qd-desc">
                                        <textarea id="content-area" name="ques_details" placeholder="选填，详细说明您的问题，以便获得更好的答案">{{isset($data->ques_details)? $data->ques_details :''}}
                                        </textarea>
                                    </div>
            ...
            <a href="#" class="btn-32-green grid-r mr-5" id="enhance-submit">确定</a>
                ...
                <div class="wgt-answers   " id="wgt-answers">
                        ...
                        <div class="bd answer answer-first    " id="answer-2779366022">
                            <div class="line">
                                ...
                                <div class="line content content-new">
                                        ...
                                        <p class="line pos-relative f-aid">
                                            ...
                                            <!--<a href="#" alog-action="qb-pump-ask" hidefocus="true"
                                               class="asker-btn asker-pump-btn goon-ask ml-15" id="pump-ask-2779366022">追问</a>-->
											    <a href="#" alog-action="qb-pump-ask" hidefocus="true"
                                               class="asker-btn asker-pump-btn goon-ask ml-15" id="#">追问</a>
                                    ...
                                    <div class="asker-editor-box" id="aabb">
                    ...
                    <div class="question-description f-pening" id="question-description">
						...
						<input type="hidden" name="lanmu_id" value="{{$data->lanmu_id}}"/>
                        <div class="qd-layout">
                            <div class="qd-content qd-content-desc">
                                    <div class="qd-ct qd-desc">
	...
	@endforeach				
                    <!--
                        <div class="bd answer answer-last  answer-fold  " id="answer-2779072143">
                            <div class="line">
                                <a id="here" name="here"></a>
                                <div class="line content content-new">
                                    <div id="answer-content-2779072143" accuse="aContent" class="answer-text line">
                                        <span class="con">
                                        至少 html,css,js,mysql.,php语法
                                        </span>
                                    </div>
                                    <div class="line info f-light-gray mt-10 mb-5 f-12">
                                        <div class="grid pt-5">
                                            热心网友<span class="f-pipe">|</span>
                                            <span class="pos-time">
                                            发布于2017-06-28 16:42
                                            </span>
                                        </div>
                                    ...
                                    <div class="asker-adopt asker-operations-e mt-10">
                                        <p class="line pos-relative f-aid">
                                            <ins class="accuse-area" alog-action="qb-accuse-link"></ins>
                                            <span alog-action="qb-comment-btn" class="comment f-black cursor asker-btn"
                                                  id="comment-2779072143"><i
                                                    class="iknow-qb_home_icons i-icon-comment mr-5"></i>评论</span>
                                            <a href="#" alog-action="qb-pump-ask" hidefocus="true"
                                               class="asker-btn asker-pump-btn goon-ask ml-15" id="pump-ask-2779072143">追问</a>
                                            <a href="#" alog-action="qb-adopt-ask" hidefocus="true"
                                               class="btn-adopt-ask ml-5" id="adopt-ask-2779072143"
                                               data-log="type:2060,action:click,area:adopt-ask,page:qb">
                                                采纳答案</a>
                                        </p>
                                    </div>
                                    <div class="asker-editor-box">
                                        <div id="editor-2779072143" class="editor"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wgt-asker-push mod-shadow">
                    <div class="asker-push-loading">
                        <i class="i-push-loading mr-10"></i>
                        <span>我们正在为您查找相关知识</span>
                    </div>
                </div>
                <script id="t:asker-push-title" type="text/html">
                    <div class="asker-push-title">
                        <i class="iknow-qb_home_icons"></i>
                        <span>看看以下知识是否对您有帮助</span>
                    </div>
                </script>
                <script id="t:asker-push-list" type="text/html">
                    <div class="asker-push-list">
                        <#for ( var i = 0; i
                        <
                        related.length && related[i]; i++ ) {#>
                        <div class="asker-push-item<#if ( related.length-1 == i ) {#> clearb<#}#>">
                            <dl class="asker-push-ask line">
                                <dt class="f-pening">问：</dt>
                                <dd><a log="pos:push-related,index:<#=i#>,action:click"
                                       href="/question/<#=related[i].qid#>.html?fr=push" target="_blank">
                                    <#:=related[i].title#>
                                </a></dd>
                            </dl>
                            <dl class="asker-push-answer line f-pening">
                                <dt>答：</dt>
                                <dd class="f-14">
                                    <#:=related[i].answer#>
                                </dd>
                        ...
                        <#}#>
                            <a log="pos:push-related-more,action:click"
                               href="/search?lm=0&rn=10&pn=0&fr=search&word=<#=word#>" target="_blank"
                               class="asker-push-more">更多类似问题 ></a>
                    </div>
                </script>
                <script id="t:asker-push-baike" type="text/html">
                    <div class="asker-push-baike">
                        <div class="asker-push-head">
                            <a log="pos:push-baike,action:click" href="http://baike.baidu.com/view/<#=baike.id#>.htm"
                               target="_blank">
                                <#:=baike.title#>_百度百科
                            </a>
                        </div>
                        <a log="pos:push-baike,action:click" href="http://baike.baidu.com/view/<#=baike.id#>.htm"
                           class="asker-push-pic mr-10 grid" target="_blank">
                            <img src="<#-__2ssl__('http:\/\/imgsrc.baidu.com\/baike\/abpic\/item\/' + baike.picSrc + '.jpg')#>"/>
                        </a>
                        <p class="asker-push-desc">
                            <#:=baike.abstract#>
                        </p>
                        <#if(baike.tagList.length > 0){#>
                            <ul class="asker-push-tag line">
                                <#for(var i = 0; i
                                <
                                baike.tagList.length; i++){#>
                                <li class="grid"><a log="pos:push-baike,action:click" class="f-aid"
                                                    href="http://baike.baidu.com/view/<#=baike.id#>.htm#<#=(i+1)#>"
                                                    target="_blank">
                                    <#=baike.tagList[i].tagName#>
                                </a></li>
                                <#if(i != baike.tagList.length-1){#>
                                    <span class="f-pipe grid">|</span>
                                    <#}#>
                                        <#}#>
                            </ul>
                            <#}#>
